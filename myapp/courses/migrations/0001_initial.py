# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-01-05 16:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[(0, b'programming'), (1, b'mcq'), (2, b'blank'), (3, b'others')], default=0, max_length=5, verbose_name='question type')),
                ('description', models.TextField(blank=True, null=True, verbose_name='description')),
                ('solution', models.TextField(blank=True, null=True, verbose_name='solution')),
                ('assessment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='blankquestion', to='courses.Assessment')),
            ],
            options={
                'verbose_name': 'blank_question',
                'verbose_name_plural': 'blank_questions',
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True, verbose_name='description')),
                ('solution', models.TextField(blank=True, null=True, verbose_name='solution')),
                ('assessment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mcq', to='courses.Assessment')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assessment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='programmingquestion', to='courses.Assessment')),
            ],
            options={
